...
public class Snowworld extends BasicGame {
    ...
    public void init(GameContainer gameContainer) throws SlickException {
        ...
        for (int i = 0; i < 100; i++) {
            this.snowflakes.add(new Snowflakes(Snowflakes.SIZE.BIG));
            this.snowflakes.add(new Snowflakes(Snowflakes.SIZE.MEDIUM));
            this.snowflakes.add(new Snowflakes(Snowflakes.SIZE.SMALL));
        }
    }
